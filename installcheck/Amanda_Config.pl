...
$testconf->add_catalog('catalog1', [ ]);
$testconf->add_catalog('"catalog2"', [ ]);
$testconf->add_catalog('"catalog3"', [ catalog1 => undef, '"catalog2"' => undef ]);
...
$testconf->add_param('catalog', 'catalog1');
...
$testconf->add_param('catalog', '"catalog2"');
