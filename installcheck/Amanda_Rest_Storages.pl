...
is_deeply (Installcheck::Config::remove_source_line($reply),
    { body =>
        [ {     'source_filename' => "$amperldir/Amanda/Changer.pm",
                'severity' => $Amanda::Message::ERROR,
		'type'     => 'fatal',
                'message' => 'Storage \'DISKFLAT\': You must specify one of \'tapedev\' or \'tpchanger\'',
...
is_deeply (Installcheck::Config::remove_source_line($reply),
    { body =>
        [ {     'source_filename' => "$amperldir/Amanda/Changer/diskflat.pm",
                'severity' => $Amanda::Message::ERROR,
		'dir'     => $taperoot,
                'message' => "Storage 'DISKFLAT': Can't create vtape root '$taperoot': No such file or directory",
