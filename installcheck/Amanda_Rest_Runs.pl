...
is_deeply (Installcheck::Rest::remove_source_line($reply),
    { body =>
		...
		'cfgerror' => "'$config_dir/BADCONF/amanda.conf', line 5: could not open conf file '$config_dir/BADCONF/amanda.conf': No such file or directory",
		'message' => "config error: '$config_dir/BADCONF/amanda.conf', line 5: could not open conf file '$config_dir/BADCONF/amanda.conf': No such file or directory",
