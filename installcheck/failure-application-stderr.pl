...
is_deeply($reply->{'body'}->[0]->{'report'}->{'failure_summary'}, [
	"  localhost diskname2 lev 0  FAILED [OUTPUT TO STDERR]",
	...
	'localhost' => {
		'diskname2' => {
			$timestamp => {
				...
				'esize' => '1075200',
				'retry_level' => '-1',
				'message' => 'dump failed: [OUTPUT TO STDERR]',
				'chunk_time' => undef,
				'dsize' => '1075200',
				'taped' => '1',
				'status' => '12',
...
localhost:diskname2 $timestamp 0      1050k dump failed: [OUTPUT TO STDERR], written (00:00:00)
...
chunker0 busy   : 00:00:00  ( 74.34%)
 dumper0 busy   : 00:00:00  (  5.99%)
TESTCONF busy   :  0:00:00  (  0.56%)
