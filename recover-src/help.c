...
help_list(void)
{
    ...
    g_printf("listproperty                       - list property\n");
    ...
    g_printf("setdevice [[-h host] device]       - select tape server and/or device\n");
    g_printf("setproperty [append] [priority] name [value ...] - set a property\n");
