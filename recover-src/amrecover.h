...
extern void set_directory(char *dir, int verbose);
extern void local_cd(char *dir);
extern void cd_glob(char *dir, int verbose);
extern void cd_regex(char *dir, int verbose);
extern void cd_dir(char *dir, char *default_dir, int verbose);
